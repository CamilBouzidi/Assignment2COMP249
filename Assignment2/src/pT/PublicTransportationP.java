...
public class PublicTransportationP {
	 ...
	 * @return Public Transportation object
	 */
	public PublicTransportationP(double ticketP, int nStops) {
	 ...
	 */
	public PublicTransportationP(PublicTransportationP p1) {
	...
	public boolean equals(Object x) {
		if ( (this.getClass()!= x.getClass())||(x==null))//x==null is important to make sure the object being compared to isn't null.
			...
			PublicTransportationP y = (PublicTransportationP) x;
	 ...
	 */
	public PublicTransportationP clone() {
		return new PublicTransportationP(this);
	}
